...
keyvOfficialTests(test, Keyv, 'postgresql://postgres:postgres@localhost:5433/keyv_test', 'postgresql://foo');

const store = () => new KeyvPostgres({uri: 'postgresql://postgres:postgres@localhost:5433/keyv_test', iterationLimit: 2});
